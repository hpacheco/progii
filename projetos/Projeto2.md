...
* Qual o ano de eleições com um maior número de eleitores na Área Metropolitana do Porto (considere a região `NUTS III` com o mesmo nome)? Complete a definição da função `eleitoresPorto`, que retorna o ano em questão.
