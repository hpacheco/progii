...
offset = width
# desenha cada camada de solo de cima pra baixo
for n,t,c in layers:
    ps = [(0,offset),(width,offset),(width+w,offset-h),(width+w,offset-h+t),(width,offset+t),(0,offset+t)]
    pygame.draw.polygon(terrain,c,ps)
    darker_c = tuple([max(0,rgb-50) for rgb in c])
    pygame.draw.line(terrain,darker_c,(width,offset+t),(width,offset),width=1)
    offset +=t
