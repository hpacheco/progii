...
meses_2023 = { mes.month : c for mes,c in meses_date.items() if mes.year == 2023 }
...
meses_mais_secos_2023 = { k for k,v in meses_2023.items() if v==mais_seco_2023 }
print (mais_seco_2023,meses_mais_secos_2023)

meses_2023_tbl = [['mes','secura']] + [ [m,s] for m,s in meses_2023.items() ]

print(meses_2023_tbl)

with open('test.csv','w') as f:
    wr = csv.writer(f,delimiter=',')
    wr.writerows(meses_2023_tbl)