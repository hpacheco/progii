...
codes = pd.read_csv("../19/country-codes.csv",usecols=['ISO3166-1-Alpha-3','ISO3166-1-Alpha-2'])
codes = codes.rename(columns={'ISO3166-1-Alpha-3':'ISO_A3','ISO3166-1-Alpha-2':'ISO_A2'})
df = pd.read_csv("../19/WHO-COVID-19-global-data.csv")
...
with open('../19/countries.geojson','r') as f: geojson = json.load(f)
