...
meses_2021 = { mes.month : c for mes,c in meses_date.items() if mes.year == 2021 }
...
def chave(mes): return desclassifica(meses_2021[mes])

mes = min(meses_2021,key=chave)
print (mes,meses_2021[mes])

meses_2021_tbl = [['mes','secura']] + [ [m,s] for m,s in meses_2021.items() ]

print(meses_2021_tbl)

with open('test.csv','w') as f:
    wr = csv.writer(f,delimiter=',')
    wr.writerows(meses_2021_tbl)